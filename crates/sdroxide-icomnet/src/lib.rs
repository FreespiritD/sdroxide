...
//!
//! There is no I/Q. No Icom offers it over any interface. Two things stand in
//! for it, and this crate carries both:
//!
//! * The scope sweep — 475 finished magnitude bins covering up to ±500 kHz.
//!   Not I/Q, but the engine already has a lane for pre-computed bins.
