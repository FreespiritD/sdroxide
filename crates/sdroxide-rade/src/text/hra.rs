...
pub(crate) const HA_COLS: [[u8; 3]; 56] = [
    [3, 13, 40], [32, 45, 54], [21, 38, 46], [1, 26, 43],
    [6, 42, 55], [11, 21, 45], [14, 18, 19], [40, 44, 54],
    [5, 15, 20], [1, 22, 39], [7, 30, 36], [3, 51, 52],
    [0, 2, 12], [6, 7, 31], [19, 50, 51], [9, 12, 21],
    [1, 30, 31], [0, 10, 23], [27, 30, 43], [6, 35, 41],
    [2, 10, 48], [24, 27, 37], [17, 29, 47], [18, 20, 23],
    [16, 37, 55], [14, 25, 47], [7, 41, 49], [12, 28, 38],
    [8, 22, 25], [11, 32, 49], [38, 44, 53], [5, 18, 25],
    [16, 27, 36], [31, 39, 55], [2, 9, 13], [5, 22, 26],
    [9, 40, 45], [17, 24, 43], [3, 28, 44], [33, 35, 42],
    [0, 28, 52], [13, 48, 51], [8, 37, 39], [4, 10, 20],
    [14, 29, 50], [11, 41, 46], [4, 15, 29], [34, 36, 49],
    [4, 48, 50], [16, 34, 42], [15, 17, 26], [35, 46, 53],
    [19, 23, 52], [8, 24, 47], [33, 53, 54], [32, 33, 34],
];
